...
Tags: content, addendum, disclaimer, bio, post, advertising
...
Easily create and format disclaimers, bios, or any other type of content, and add below your posts and pages with a simple dropdown.
...
= 1.0.1 = 
Updated description and added icon, banner. This is the good-to-go version.

= 1.0.2 =
Fixed post warning - check if checkbox is checked before updating post meta.
